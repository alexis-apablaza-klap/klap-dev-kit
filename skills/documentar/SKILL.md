---
name: documentar
description: "Actualiza la memoria versionada del repo y, si corresponde, Confluence + targeted-sync, a partir de un cambio ya implementado. Uso: /klap:documentar [ISSUE-KEY]"
---
...
producto, y sólo entonces `targeted_sync`.
